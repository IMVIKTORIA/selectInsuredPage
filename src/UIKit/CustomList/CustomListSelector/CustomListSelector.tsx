...
function CustomListSelector(props: CustomListSelectorProps) {
  ...
  const singleLayout = isChecked ? Icons.Checked : Icons.Unchecked;

  const backgroundColor = !isMultiple ? { backgroundColor: "#f8f8f8" } : {};

  return (
    <div className="custom-list-selector" style={backgroundColor}>
